...
public class RestClientController {
	...
	public String getAll(Model model) {
		...
		try {
			ResponseEntity<PersonList> result = restTemplate.exchange(baseURL+"persons", HttpMethod.GET, entity, PersonList.class);
			// Add to model
	...
	public String getPerson(@RequestParam("id") Long id, Model model) {
		...
		// Send the request as GET
		try {
			ResponseEntity<Person> result = restTemplate.exchange(baseURL+"person/{id}", HttpMethod.GET, entity, Person.class, id);
			// Add to model
	...
	public String addPerson(@ModelAttribute("personAttribute") Person person, Model model) {
		...
		try {
			ResponseEntity<Person> result = restTemplate.exchange(baseURL+"person", HttpMethod.POST, entity, Person.class);
		} catch (Exception e) {
			logger.error(e);
		}
	...
	public String updatePerson(@ModelAttribute("personAttribute") Person person,
		...
		ResponseEntity<String> result = restTemplate.exchange(baseURL+"person/{id}", HttpMethod.PUT, entity, String.class, id);
	...
	public String deletePerson(@RequestParam("id") Long id,
		...
		ResponseEntity<String> result = restTemplate.exchange(baseURL+"person/{id}", HttpMethod.DELETE, entity, String.class, id);
